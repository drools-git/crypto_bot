...
:: Start Backend Server using Conda (Force 127.0.0.1 for consistency)
start "Crypto Bot Backend" cmd /k "cd backend && conda run -n crypto_bot uvicorn app.main:app --host 127.0.0.1 --port 8000 --reload"
