...
:: Start Backend Server using Conda (Listen on all interfaces for maximum compatibility)
start "Crypto Bot Backend" cmd /k "cd backend && conda run -n crypto_bot uvicorn app.main:app --host 0.0.0.0 --port 8000"
